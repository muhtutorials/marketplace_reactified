"""
Django settings for marketplace_reactified project.
...
SECRET_KEY = 'vrz9ufo70%w1oqsmxx(l28((6g(o85qv$^2gx+k%*yxj$bbo%9'
...
INSTALLED_APPS = [
    ...
    # without specifying path to "Config" class "ready" method isn't executed
    # and therefore signals defined outside models.py file aren't executed
...
ROOT_URLCONF = 'marketplace_reactified.urls'
...
WSGI_APPLICATION = 'marketplace_reactified.wsgi.application'
